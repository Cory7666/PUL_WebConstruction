...
<body>
    ...
    <div>
        <ul id="content-navbar" class="nav justify-content-center bg-light">
            ...
            <div data-bs-spy="scroll" data-bs-target="#content-navbar" data-bs-offset>
                ...
                <div id="block-3">
                    ...
                    <div class="row row-cols-2">
                        <div class="col mb-2">Исполнительный директор:</div> <div class="col">+7(978)803-12-34 (Алексей)</div>
                        <div class="col mb-2">Операторы:</div> <div class="col">+7(978)803-12-34 (Андрей)</div>
                        <div class="col mb-2">Исходный код проекта:</div> <div class="col"><a href="https://github.com/Cory7666/PUL_WebConstruction.git" hreflang="en" target="_blank">Github</a></div>
                    </div>
                </div>
            </div>
        </div>
